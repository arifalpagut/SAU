...
const getEmployeeLeaveInfo = catchAsync(async (req, res) => {
  const data = await leaveService.getEmployeeLeaveInfo(req.params.employeeId);
  return success(res, data, 'Calisan izin bilgileri getirildi');
});

module.exports = { listLeaves, createLeave, approveLeave, rejectLeave, cancelLeave, listLeaveTypes, createLeaveType, getLeaveBalance, getLeaveCalendar, getEmployeeLeaveInfo };
