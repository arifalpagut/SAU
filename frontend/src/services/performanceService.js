...
export const performanceService = {
  ...
  listCriteria: () => api.get('/api/performance/criteria'),
  scoreCriteria: (evaluationId, scores, feedback) => api.post(`/api/performance/evaluations/${evaluationId}/score-criteria`, { scores, feedback })
};